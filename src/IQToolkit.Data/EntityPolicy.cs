...
namespace IQToolkit.Data
{
    ...
    public class EntityPolicy : QueryPolicy
    {
        ...
        /// <summary>
        /// Add a filter condition to an association member that is applied as part of the JOIN condition.
        ...
        /// Works with both singleton associations and collection associations.
        /// Compatible with IncludeWith for eager loading.
        /// </remarks>
        ...
        internal LambdaExpression GetAssociationFilter(MemberInfo member)
        {
